...
export const footerLinks = [
  ...
  },
  {
    title: "Besoin d'aide?",
    links: [
      { text: "Informations sur la livraison", url: "#" },
      { text: "Politique de retour et de remboursement", url: "#" },
      { text: "Méthodes de paiement", url: "#" },
      { text: "Suivez votre commande", url: "#" },
      { text: "Contactez-nous", url: "#" },
    ],
  },
  {
